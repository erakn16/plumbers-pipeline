          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[280px] md:auto-rows-[300px]">
              ...
              <div className="md:col-span-2 md:row-span-2 rounded-3xl bg-card border border-border p-8 flex flex-col justify-between overflow-hidden relative group shadow-sm hover:shadow-xl transition-shadow duration-500">
                ...
                <div className="bg-primary/10 w-10 md:w-12 h-10 md:h-12 rounded-lg md:rounded-xl flex items-center justify-center">
                  <Briefcase className="w-5 md:w-6 h-5 md:h-6 text-primary" />
                </div>
